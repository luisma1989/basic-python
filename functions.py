...
# Los nombres de las funciones deben ser descriptivas
# de lo que hacen las funciones
# Imprimir valor de variable

# Para poder imprimir el valor de una variable dentro
# de un string podemos hacerlo así:
